...
namespace JustOrganize.TeamService.LocationClient
{
        ...
        public async Task<LocationRecord> AddLocation(Guid memberId, LocationRecord locationRecord)
        {
            using (var httpClient = new HttpClient())
            {
                ...
                HttpResponseMessage response =
                  await httpClient.PostAsync(uri, new StringContent(jsonString, System.Text.Encoding.UTF8, "application/json"));
